 ...
 * @author Huy
 */
public class beqDrawing extends ModelDrawing{
	private int [][]arrayLine ={
			...
			{250,350,250,250},{250,250,370,250},{250,395,250,470},{250,470,350,470},
			{300,380,300,430},{300,430,350,430},{395,220,395,210},{395,210,240,210},
			...
			{660,185,685,185},{205,100,685,100},{600,100,600,70},{600,70,790,70},
			{750,140,795,140},{420,265,560,265},{560,265,560,630},{560,630,650,630},
			{650,630,650,610},{680,570,750,570},{750,570,750,440},{765,400,775,400},
			{775,400,775,200},{775,200,780,200},{411,226,780,226},{820,215,825,215},
			{825,215,825,150},{840,100,890,100},{890,100,890,20},{890,20,20,20},
			{20,20,20,350},{20,350,50,350},{765,410,820,410},{570,420,570,500},
			{570,500,820,500},{418,282,860,282},{860,282,860,400},{417,240,870,240},
			{870,240,870,400},{775,410,775,550},{775,550,935,550},{935,550,935,465},
			{935,465,950,465},{910,410,950,410},{420,250,965,250},{965,250,965,400},
			{410,305,450,305},{450,305,450,330},{980,440,1010,440},{1010,440,1010,650},
			{1010,650,390,650},{390,650,390,470},{390,470,410,470}
	};
	...
	private void DrawingAnimatedLine(Graphics2D gr2d, int X1, int Y1)
	{
        ...
        {
            if(isEqual)
            {	if((lineNumber>13 && lineNumber<19)||(lineNumber>30&&lineNumber<33)||(lineNumber>40&&lineNumber<53)||(lineNumber>60&&lineNumber<65)||(lineNumber>69&&lineNumber<74))
        	{
        		gr2d.create();
        		gr2d.setPaint(getInsColor());
        		gr2d.drawLine(X1, Y1,xdyn,ydyn);
        	}
        	else if((lineNumber>10&&lineNumber<14)||lineNumber==19||(lineNumber>21&&lineNumber<26)||lineNumber ==30||(lineNumber>37&&lineNumber<40)||(lineNumber>57&&lineNumber<61)||(lineNumber>64&&lineNumber<70)||lineNumber>73)
			{
				gr2d.create();
        	...
        	else if((lineNumber>10&&lineNumber<14)||lineNumber==19||(lineNumber>21&&lineNumber<26)||lineNumber ==30||(lineNumber==40)||(lineNumber>57&&lineNumber<61)||(lineNumber>64&&lineNumber<70)||lineNumber>73)
			{
				gr2d.create();
				gr2d.setPaint(getUniColor());
				gr2d.drawLine(X1, Y1,xdyn,ydyn);
			...
			for(int i=0;i < lineNumber ;i++)
			{
				if(i==2)
					gr2d.drawString("4", 90, 132);
                                if(isEqual)
                                {if((i > 13 && i < 19)||(i>30&&i<33)||(i>40&&i<53)||(i>60&&i<65)||(i>69&&i<74))
				{
					gr2d.create();
					gr2d.setPaint(getInsColor());
                                    switch (i) {
				...
				else if((i>10&&i<14)||i==19||(i>21&&i<26)||i==30||(i>37&&i<40)||(i>57&&i<61)||(i>64&&i<70)||i>73)
				{
					gr2d.create();
					gr2d.setPaint(getUniColor());
					if(i==11)
				...
				else if((i>10&&i<14)||i==19||(i>21&&i<26)||i==30||(i==40)||(i>57&&i<61)||(i>64&&i<70)||i>73)
				{
					gr2d.create();
					gr2d.setPaint(getUniColor());
					if(i==11)
