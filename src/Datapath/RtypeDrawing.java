...
public class RtypeDrawing extends ModelDrawing{
	
    
    
	private int [][]arrayLine ={{90,350,140,350},{115,350,115,50},{115,50,142,50},{100,130,142,130},
								...
								{250,470,250,560},{250,560,400,560},{400,560,400,620},{400,620,540,620},
								{540,620,540,570},{540,570,620,570},{400,560,450,560},{550,365,700,365},
								...
								{860,282,860,400},{417,240,870,240},{870,240,870,400},{765,410,775,410},
								{775,410,775,550},{775,550,935,550},{935,550,935,465},{935,465,950,465},
								{910,410,950,410},{420,250,965,250},{965,250,965,400},{410,305,450,305},
								{450,305,450,330},{980,440,1010,440},{1010,440,1010,650},{1010,650,390,650},
								{390,650,390,470},{390,470,410,470}};
	...
	private void DrawingAnimatedLine(Graphics2D gr2d, int X1, int Y1)
	{
        ...
        if(xdyn != 0 && ydyn!= 0)
        {
        	if((lineNumber>13 && lineNumber<19)||(lineNumber>31&&lineNumber<34)||(lineNumber>42&&lineNumber<55)||(lineNumber>62&&lineNumber<67)||(lineNumber>72&&lineNumber<77))
        	{
        		gr2d.create();
        		gr2d.setPaint(getInsColor());
        		gr2d.drawLine(X1, Y1,xdyn,ydyn);
        	}
        	else if((lineNumber>11&&lineNumber<14)||(lineNumber==26)||(lineNumber>28&&lineNumber<32)||(lineNumber>34&&lineNumber<38)||(lineNumber>40&&lineNumber<43)||(lineNumber>59&&lineNumber<63)||lineNumber==72)
			{
				gr2d.create();
	...
	{	
                ...
                if(lineNumber >= 1)
		{
			...
			if((i > 13 && i < 19)||(i>31&&i<34)||(i>42&&i<55)||(i>62&&i<67)||(i>72&&i<77))
			{
				gr2d.create();
				gr2d.setPaint(getInsColor());
                                switch (i) {
				...
				else if((i>11&&i<14)||(i==26)||(i>28&&i<32)||(i>34&&i<38)||(i>40&&i<43)||(i>59&&i<63)||(i==72))
				{
					gr2d.create();
					gr2d.setPaint(getUniColor());
					if(i==26)
